...
function check_download {
    ...
    if [ ! -d "${K_SHAKETUNE_PATH}" ]; then
        ...
        if git -C $shaketunedirname clone https://github.com/elusznik/klippain-shaketune.git $shaketunebasename; then
...
type: git_repo
origin: https://github.com/elusznik/klippain-shaketune.git
